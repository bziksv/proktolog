...
$APPLICATION->SetPageProperty("description", "Инструменты и оборудование для врача проктолога или для оснащения кабинета проктолога. Полный перечень, все приборы с документами качества. Цены как от производителя. Звоните! Медицинское оборудование с доставкой по РФ");
$APPLICATION->SetPageProperty("title", "Медицинские инструменты и приборы для проктологии от производителя - интернет магазин с доставкой по РФ");
$APPLICATION->SetTitle("proktolog.su - поставки медицинской техники от производителя по всей России");
?>
